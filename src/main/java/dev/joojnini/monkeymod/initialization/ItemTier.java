...
public class ItemTier {
    ...
    public static final ForgeTier COPPERHOE = new ForgeTier(2, 211, 5.0f, 0f, 22, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(net.minecraft.world.item.Items.COPPER_INGOT));
}
